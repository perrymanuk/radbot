...
DEFAULT_TOKEN_PATH = os.path.join(
    os.path.expanduser("~"), ".radbot", "calendar_token.json"
)
...
def _get_token_path() -> str:
    ...
    try:
        ...
        cal_config = (
            config_manager.get_config().get("integrations", {}).get("calendar", {})
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Set up Calendar authentication for radbot"
    )
    parser.add_argument(
        "--port",
        type=int,
